...
public class MainFrameTest {
    ...
    void layersYAxisOffset_returnsCorrectOffsets() {
        ...
        NeuralNetwork neuralNetwork = new NeuralNetwork(new int[]{2, 5, 3});
        int[] offsets = neuralNetworkPanel.layersYAxisOffset(neuralNetwork);
        assertThat(offsets[0], is(0));
        assertThat(offsets[1], is(60));

        NeuralNetwork neuralNetwork2 = new NeuralNetwork(new int[]{2, 4, 1, 2});
        ...
        NeuralNetwork neuralNetwork3 = new NeuralNetwork(new int[]{2, 2, 8, 7});
