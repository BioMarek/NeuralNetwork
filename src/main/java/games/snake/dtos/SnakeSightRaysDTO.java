...
public class SnakeSightRaysDTO implements SnakeSightDTO {
    private final double[] result = new double[8];
    private final int[][] grid;
    private final int rows;
    private final int columns;

    public SnakeSightRaysDTO(int[][] grid) {
        this.grid = grid;
    ...
    public void calculateSightRay(AbstractSnake snake, int rowIncrease, int columnIncrease, int index) {
